...
cm_rf
```
We see that the accuracy rate of the model is very high `r cm_rf$overall["Accuracy"]` , and therefore out-of the sample error is about `r 1-cm_rf$overall["Accuracy"]`.
